    ...
    <div class="container-fluid">
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="Input_BarangAdmin.php">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <h3>Input Barang</h3>
          <a href="TambahBarangAdmin.php"><button>Tambah Barang Baru</button></a>
          <form action="Input_BarangAdminPros.php" method="post">
            <table>
              <tr>
                <td>Nama Barang :</td>
